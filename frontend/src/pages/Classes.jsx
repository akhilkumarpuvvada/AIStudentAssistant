...
const Classes = () => {
  const { classes, fetchClasses, api, navigate} = useAppContext();
      ...
      <div className="p-10 min-h-screen">
        <div className="flex items-center justify-between px-6 mb-6">
          ...
          <button
            ...
            className="bg-green-600 px-5 py-3 text-white rounded-lg shadow hover:bg-green-700 cursor-pointer transition-colors"
          >
            Add Class
          </button>
        </div>
          ...
          <table className="w-full text-left border text-sm uppercase">
            ...
            <tbody>
              {classes.map((cls, index) => (
                <tr
                  key={index}
                  className="hover:bg-gray-50 transition-colors border-b font-medium"
                >
                  ...
                  <td>
                    <button
                      ...
                      className="p-6 text-red-600 cursor-pointer hover:bg-red-100 rounded-lg transition-colors"
                    >
